...
<body>
  ...
  <div class="titulo">DEFINICI&Oacute;N DE CLIENTES iNLASH & Co</div>
     <div class="capa_form_sf">
        ...
        <table width="80%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
			<th>Eps:</th>
            <td><input type="text" name="p_eps" id="p_eps" size="50" maxlength="200" />
            <input type="hidden" name="p_id_eps" id="p_id_eps" /></td>
          </tr>
          <tr>
			<th>Prepagada:</th>
            <td><input type="text" name="p_prepagada" id="p_prepagada" size="50" maxlength="200" />
            <input type="hidden" name="p_id_prepagada" id="p_id_prepagada" /></td>
          </tr>
          <tr>
