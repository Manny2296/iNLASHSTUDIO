...
if (isset($_SESSION['id_perfil'])) {
	if ( validar_permisos ($conn, 'usuarios_lst.php') ) {
		$t_tipo[0]['texto'] = "Tipo de usuario";
		$t_tipo[0]['valor'] = "perfil";
		$t_tipo[1]['texto'] = "Número de documento de identidad";
		$t_tipo[1]['valor'] = "id";
...
<title>.:: MY INLIFE STUDIO - Consulta de usuarios del sistema ::.</title>
<!-- InstanceEndEditable -->
