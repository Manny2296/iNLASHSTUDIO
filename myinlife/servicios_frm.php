  ...
  <div class="titulo">CONFIGURACI&Oacute;N DE SERVICIOS</div>
     <div class="capa_form_sf">
        ...
        <table width="80%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
			<th>Cantidad de sesiones simult&aacute;neas permitidas:</th>
            <td><input type="text" name="p_sesiones_simultaneas" id="p_sesiones_simultaneas" size="4" maxlength="4" value="<?php if(!is_null($v_id_servicio)){echo($r_servicio['sesiones_simultaneas']);} ?>" /></td>
          </tr>
          <tr>
