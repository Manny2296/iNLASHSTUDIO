...
if (isset($_SESSION['id_perfil'])) {	
	if ( validar_permisos ($conn, 'exec_del_usuario.php') ) {
...
<title>.:: MY INLIFE STUDIO - Eliminaci&oacute;n de usuarios ::.</title>
<!-- InstanceEndEditable -->
...
<body>
  <div id="contendor">
	 ...
	 <?php 
    if($v_result) {
  		mensaje_form(1, 'El usuario fue eliminado correctamente', 'usuarios_lst.php', $t_campos, $t_valores); 
	} else {
		mensaje_form(2, 'El usuario no pudo ser eliminado', 'usuarios_lst.php', $t_campos, $t_valores); 
	}
	?>
	 <!-- InstanceEndEditable -->
     </div>
